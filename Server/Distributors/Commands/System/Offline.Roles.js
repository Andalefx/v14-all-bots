...
// v14 Uyumlu Importlar: Discord objesini ve EmbedBuilder'ı tanımlıyoruz.
const Discord = require("discord.js"); 
const { Client, Message, EmbedBuilder } = Discord;
const { genEmbed } = require("../../../../Global/İnit/Embed");

module.exports = {
    Isim: "offlineroles",
    Komut: ["of-roles","offline-roles","kapalılar","çıkmışyetkililer"],
    Kullanim: "offlineroles <@andale/ID> <Miktar>",
...
    let çevrimdışılar = data || []
    ...
    // Rol ve Üye bulma metodları v14'te de aynı şekilde çalışır.
...
     }
    ...
    // Mesajı bölme işlemi (Discord.Util.splitMessage v14'te de geçerlidir)
    if(!rolBul || !uyeBul) {
