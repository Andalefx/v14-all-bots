...
module.exports = {
    ...
    Kullanim: "undc <#No/@andale/ID>", // Kullanim güncellendi
    Aciklama: "Belirlenen üyenin Doğruluk mu? Cesaretlik mi? cezalı rolünü kaldırır.",
    Kategori: "yetkili",
    Extend: true,
    ...
    */
    ...
    onRequest: async function (client, message, args) {
        ...
        if(Number(hedefArg)) {
            let cezanobul = await DC.findOne({No: hedefArg});
