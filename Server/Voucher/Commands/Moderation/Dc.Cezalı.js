...
module.exports = {
    ...
    Kullanim: "dccezalı <@üye/ID>",
    Aciklama: "Belirtilen üyeyi etkinlikten cezalandırır.",
    Kategori: "yetkili",
    Extend: true,
    ...
    */
    ...
    onRequest: async function (client, message, args) {
        ...
        // V14 Yetki Kontrolü: ADMINISTRATOR için PermissionFlagsBits kullanıldı.
        ...
        }).setDescription(`Belirtilen ${uye} isimli üyeyi **${aktivite}** etkinliğinden cezalandırmak istiyor musun?`);
        ...
        collector.on('collect', async i => {
            if (i.customId === `onayla`) {
                ...
                const v14SelectOptions = sebeps.filter(x => x.type == 11).map(s => ({
                    label: s.label,
