...
module.exports = {
    ...
    Kullanim: "reklam <@andale/ID>", // Kullanim güncellendi
    Aciklama: "Belirtilen üyeyi reklam gerekçesiyle cezalandırır.",
    Kategori: "yetkili",
    Extend: true,
    ...
    */
    ...
    onRequest: async function (client, message, args) {
        // V14 PermissionFlagsBits kullanımı
        ...
        collector.on('collect', async i => {
            if (i.customId === `onayla`) {
                ...
                // Custom fonksiyonlar (removeStaff, dangerRegistrant, addPunitives) V14'te de aynı şekilde çalışacaktır.
                uye.removeStaff()
                uye.dangerRegistrant()
                
                if(Number(ayarlar.reklamLimit)) {
                    // V14 PermissionFlagsBits.Administrator kullanımı
