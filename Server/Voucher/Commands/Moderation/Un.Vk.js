...
module.exports = {
    ...
    Kullanim: "unvk <#No/@andale/ID>", // Kullanim güncellendi
    Aciklama: "Belirlenen üyenin Vampir Köylü cezalı rolünü kaldırır.",
    Kategori: "yetkili",
    Extend: true,
    ...
    */
    ...
    onRequest: async function (client, message, args) {
        ...
        if(Number(hedefArg)) {
            let cezanobul = await VK.findOne({No: hedefArg});
