...
module.exports = {
    ...
    Kullanim: "unetc <#No/@andale/ID>", // Kullanim güncellendi
    Aciklama: "Belirlenen üyenin etkinlik cezalı rolünü kaldırır.",
    Kategori: "yetkili",
    Extend: true,
    ...
    */
    ...
    onRequest: async function (client, message, args) {
        ...
        if(Number(hedefArg)) {
            let cezanobul = await ETKINLIK.findOne({No: hedefArg});
